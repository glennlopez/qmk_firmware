...
[_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_BSLS, \
                 KC_LBRC ,KC_LGUI, KC_LALT, KC_LOWER, KC_SPC,      KC_ENT,  KC_RAISE, KC_MINS, KC_EQL, KC_RBRC \
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_COLEMAK] = LAYOUT( \
  ...
  KC_LSHIFT,   KC_A,   KC_R,    KC_S,    KC_T,    KC_D,                      KC_H,    KC_N,    KC_E,    KC_I,    KC_O,  KC_QUOT, \
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,      XXXXXXX,KC_K,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_BSLS, \
                 KC_LBRC ,KC_LGUI, KC_LALT, KC_LOWER, KC_SPC,      KC_ENT,  KC_RAISE, KC_MINS, KC_EQL, KC_RBRC \
),
/*
 * DVORAK
...
[_DVORAK] = LAYOUT( \
  KC_ESC,   KC_1,     KC_2,     KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_BSPC, \
  KC_TAB,   KC_GRV,   KC_COMM,  KC_DOT,  KC_P,    KC_Y,                      KC_F,    KC_G,    KC_C,    KC_R, KC_L,  KC_GRV, \
  KC_LSHIFT,   KC_A,    KC_O,     KC_E,    KC_U,    KC_I,                      KC_D,    KC_H,    KC_T,    KC_N,    KC_S,  KC_SLSH, \
  KC_LCTRL,  KC_SCLN,   KC_Q,   KC_J,    KC_K,    KC_X, KC_MUTE,      XXXXXXX,KC_B,    KC_M, KC_W,  KC_V, KC_Z,  KC_PIPE, \
                 KC_LBRC ,KC_LGUI, KC_LALT, KC_LOWER, KC_SPC,      KC_ENT,  KC_RAISE, KC_MINS, KC_EQL, KC_RBRC \
),
/* LOWER Layer
 ...
 */
[_LOWER]  = LAYOUT( \
  KC_QUI T,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     XXXXXXX, KC_NLCK, KC_SLSH,  KC_PAST,  XXXXXXX,  XXXXXXX, \
  XXXXXXX,  XXXXXXX, KC_COLN, KC_LPRN, KC_RPRN, KC_SCLN,                     XXXXXXX, KC_7,    KC_8,     KC_9,     KC_PMNS,  XXXXXXX, \
  KC_MOUSE, XXXXXXX, KC_LT, KC_LCBR,  KC_RCBR, KC_GT,                       XXXXXXX, KC_4,    KC_5,     KC_6,     KC_PPLS,   XXXXXXX, \
  KC_LSFT,  XXXXXXX, KC_PSLS, KC_LBRC, KC_RBRC, KC_BSLS, KC_MPLY,   _______, XXXXXXX, KC_1,     KC_2,    KC_3,    KC_PENT,  XXXXXXX, \
                    _______, _______, _______, _______, _______,       KC_ALTDEL, _______,  KC_0,  KC_0,  KC_DOT\
),
/* RAISE: Upper Layer
 * (Custom Macros and Function keys)
 * ,----------------------------------------.                     ,-----------------------------------------.
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  <-- F1 to F12-->  |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 | 
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |      |      |                    |      | Pscr |Scrlk |Pause |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT( \
  ...
  KC_CAPS, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,                      XXXXXXX, KC_INS, KC_HOME, KC_PGUP, XXXXXXX, XXXXXXX, \
  XXXXXXX, KC_UNDO, KC_CUT, KC_COPY, KC_PASTE, XXXXXXX,  KC_MPLY,       _______, XXXXXXX, KC_DEL, KC_END, KC_PGDN, XXXXXXX, XXXXXXX, 
...
[_ADJUST] = LAYOUT( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX,  CG_TOGG, XXXXXXX,XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  XXXXXXX, XXXXXXX, KC_DVORAK, KC_QWERTY,KC_COLEMAK,  XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, DM_RSTP,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
                         XXXXXXX, DM_REC1, DM_REC2, _______, _______,       _______, _______, DM_PLY1, DM_PLY2, XXXXXXX \
),
...
[_MOUSE] = LAYOUT( \
  XXXXXXX , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  XXXXXXX , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     KC_PGUP, KC_PTAB, KC_UP, KC_NTAB, XXXXXXX, XXXXXXX, \
  XXXXXXX , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, XXXXXXX, XXXXXXX, \
  XXXXXXX , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_WREF,    XXXXXXX,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
                   XXXXXXX, XXXXXXX, XXXXXXX, KC_LCTRL, KC_MOUSE_BTN1,     KC_MOUSE_BTN2, KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX \
)
};
...
void pointing_device_task() {
    ...
    switch (get_highest_layer(layer_state)) {
        ...
        case _RAISE:
            ...
            break;
        case _LOWER:
             trackball_set_rgbw(255,42,42,0);
            break;
        case _ADJUST:
...
static void print_status_narrow(void) {
    // Print current mode
    oled_write_P(PSTR("GLENN"), false);
    oled_write_ln_P(PSTR("LOPEZ"), false);
